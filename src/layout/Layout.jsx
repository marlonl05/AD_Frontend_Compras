...
export const Layout = ({ children }) => {
	...
	return (
		<>
			...
			{/* Menu movil */}
			<nav className='bg-dark-100 xl:hidden fixed w-full bottom-0 left-0 text-3xl text-gray-400 py-2 px-8 flex items-center justify-between rounded-tl-xl rounded-tr-xl z-10'>
			...
			<main className={'xl:pl-36 pb-10 ' + (showBillDetails && 'xl:pr-[600px]')}>
